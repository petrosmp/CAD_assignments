/**
 * \file String operations to make everything easier.
 * 
...
/**
 * Append no more than l2_c contents of of l2 to l1.
 * l1 is modified, l2 is left as is.
 * 
 * any items of l1 after l1_c will be overwritten (but properly
 * freed).
 * 
 * Return the number of items written on success, NARG on failure
